...
<div id="container" class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-xl-4">
            <div id="j_picShow" class="card bg-warning">
                <div class="card-body pic-card">
                    <div class="text-center">
                        <h3 class="font-weight-normal text-white mt-2 mb-3"><i class="mdi mdi-plus mdi-48px"></i></h3>
                        <a id="productAdd" data-href="<?php echo ($addUrl); ?>" href="javascript:void(0)" class="btn btn-outline-light btn-sm mb-1 mt-2">添加</a>
                    </div> <!-- end card-body-->
                </div> <!-- end card-->
            </div>
        </div> <!-- 图片 End. -->
        ...
        <?php for($i=0; $i<count($resultArr); $i++) { ?>
        <!-- 产品 Start. -->
        <div class="col-xl-4">
            <div class="card pic-box">
                <img class="card-img-top pic-img" src="/Cms/Public/images/pic-8.jpg" alt="">
                <!-- 按钮 Start. -->
                <div class="method-layer">
                    <div class="text-center">
                        <h4 class="font-weight-normal text-white mt-5 mb-2"><?php echo ($resultArr[$i]["name"]); ?></h4>
                        <a onclick="editProduct(this)" data-href="<?php echo ($editUrl); ?>" data-productId="<?php echo ($resultArr[$i]['id']); ?>" href="javascript:void(0)" class="edit-product btn btn-outline-light btn-sm mb-1 mt-2">编辑</a>
                        <a onclick="delProduct(this)" data-href="<?php echo ($delUrl); ?>" data-productId="<?php echo ($resultArr[$i]['id']); ?>" href="javascript:void(0)" class="btn btn-outline-danger btn-sm mb-1 mt-2">删除</a>
                    </div>
                </div> <!-- 按钮 End. -->
            </div>
        </div> <!-- 产品 End. -->
