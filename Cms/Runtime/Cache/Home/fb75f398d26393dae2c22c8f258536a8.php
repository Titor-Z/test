                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="form-group row mb-3">
                                    ...
                                    <div class="col-9">
                                        <input type="text" class="form-control" id="" placeholder="请输入店铺名称">
                                ...
                                <div class="form-group row mb-3">
                                    ...
                                    <div class="col-9">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="请输入行业实体">
                                        </div>
                                ...
                                <form class="form-horizontal">
                                    <div class="form-group row mb-3">
                                        ...
                                        <div class="col-9">
                                            <textarea type="email" class="form-control" placeholder="请输入店铺简介" rows="5"></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row mb-3">
                                        ...
                                        <div class="col-9">
                                            <input type="text" class="form-control" id="inputPassword3" placeholder="请输入主营服务">
                                    ...
                                    <div class="form-group row mb-3">
                                        ...
                                        <div class="col-9">
                                            <textarea type="email" class="form-control" placeholder="请输入营业时间" rows="5"></textarea>
                                    ...
                                    <div class="form-group row mb-3">
                                        ...
                                        <div class="col-9 input-group">
                                            <input type="password" class="form-control" id="inputPassword5" placeholder="请输入 电话 \ 手机号 ">
                                            <input type="password" class="form-control" placeholder="请输入 微信号 ">
                                        </div>
                                    </div>
